...
const CollaborationWidget: React.FC = () => {
    ...
    return (
        <div className="flex h-full gap-4">
            {/* Sidebar */}
            <div className="w-48 flex-shrink-0 flex flex-col border-r border-white/10 pr-2">
            ...
            {/* Chat Area */}
            <div className="flex-grow flex flex-col min-w-0 bg-black/20 rounded-xl overflow-hidden">
                ...
                <div className="flex-grow overflow-y-auto p-4 space-y-4">
                    ...
                    {filteredMessages.map(msg => (
                        <div key={msg.id} className="flex justify-end">
                            <div className="max-w-[80%] p-3 rounded-xl bg-[var(--grad-1)]/20 text-white rounded-tr-none border border-[var(--grad-1)]/30">
