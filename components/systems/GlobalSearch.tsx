    ...
    return (
        <div>
            ...
            <Input 
                ...
                placeholder="Search notes, tasks, files, projects, courses..."
            ...
            <div className="mt-4 max-h-[60vh] overflow-y-auto space-y-4 pr-2">
                {searchResults?.notes.length > 0 && (
                 ...
                 {searchResults?.projects.length > 0 && (
                    <div>
                        <h4 className="font-semibold text-gray-300">Projects ({searchResults.projects.length})</h4>
                        {searchResults.projects.map(item => (
                            <div key={item.ts} className="p-2 bg-black/20 rounded mt-1 text-sm">
                                <p className="font-bold">{item.name}</p>
                            </div>
                        ))}
                    </div>
